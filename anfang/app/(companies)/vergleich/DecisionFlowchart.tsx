  ...
  return (
    <div className="flex items-start justify-center w-full">
      <div className="flex flex-col items-center w-1/2">
        ...
        <span className="text-xs font-semibold text-[rgb(23,162,69)] mt-1">{leftLabel}</span>
      </div>
      <div className="w-0.5 h-4 bg-gray-300 mt-0" />
      <div className="flex flex-col items-center w-1/2">
        <div className="w-0.5 h-4 bg-gray-300" />
        <div className="flex items-center w-full">
          <div className="w-0.5 h-4 bg-gray-300" />
        ...
        <span className="text-xs font-semibold text-gray-400 mt-1">{rightLabel}</span>
      </div>
    </div>
  );
}
      ...
      <div className="max-w-[1280px] mx-auto px-12">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Folgen Sie dem Entscheidungsbaum, um herauszufinden, ob Programmier-Anfang oder {competitorName} besser zu Ihren Anforderungen passt.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex justify-center">
            <div className="bg-white border-2 border-[rgb(0,159,255)] rounded-xl px-6 py-4 shadow-sm max-w-md text-center">
              <p className="text-sm font-bold text-gray-900">
                Brauchen Sie schnelle Einstellung?
              </p>
              <p className="text-xs text-gray-500 mt-1">Innerhalb von 1 Woche?</p>
            </div>
          </div>
          ...
          <div className="flex justify-center mt-2">
            <div className="grid grid-cols-2 gap-8 w-full max-w-2xl">
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs font-bold text-[rgb(23,162,69)] bg-[rgb(23,162,69)]/10 px-2 py-0.5 rounded">JA</span>
                <div className="w-0.5 h-5 bg-gray-300" />
                <div className="bg-[rgb(23,162,69)]/5 border-2 border-[rgb(23,162,69)] rounded-xl px-5 py-4 shadow-sm text-center w-full">
                  ...
                  <p className="text-xs text-gray-600 mt-1">
                    Matching in nur 72 Stunden, schneller als die meisten Alternativen
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center">
                <div className="w-0.5 h-5 bg-gray-300" />
                <span className="text-xs font-bold text-gray-400 bg-gray-100 px-2 py-0.5 rounded">NEIN</span>
                <div className="w-0.5 h-5 bg-gray-300" />
                <div className="bg-white border-2 border-[rgb(0,159,255)] rounded-xl px-5 py-4 shadow-sm text-center w-full">
                  <p className="text-sm font-bold text-gray-900">
                    Ist DACH-Fokus wichtig?
                  </p>
                  <p className="text-xs text-gray-500 mt-1">Deutschsprachiger Support, europäische Zeitzonen?</p>
                </div>
              </div>
            </div>
          </div>

          {/* Branch 2 (from "Ist DACH-Fokus wichtig?") */}
          <div className="flex justify-center mt-2">
            <div className="grid grid-cols-2 gap-8 w-full max-w-2xl">
              {/* Spacer for left */}
              <div />
          ...
          {/* Branch 3 (from "Brauchen Sie Vorprüfung?") */}
          <div className="flex justify-center mt-2">
            <div className="grid grid-cols-2 gap-8 w-full max-w-2xl">
              {/* Spacer for left */}
              <div />
              ...
              <div className="grid grid-cols-2 gap-4">
                {/* Spacer for YES above */}
                <div />

                {/* Sub-branch from Vorprüfung */}
                <div className="grid grid-cols-2 gap-2">
                  <div className="flex flex-col items-center">
                    <div className="w-0.5 h-5 bg-gray-300" />
                    <span className="text-[10px] font-bold text-[rgb(23,162,69)] bg-[rgb(23,162,69)]/10 px-1.5 py-0.5 rounded">JA</span>
                    <div className="w-0.5 h-5 bg-gray-300" />
                  ...
                  <div className="flex flex-col items-center">
                    <div className="w-0.5 h-5 bg-gray-300" />
                    <span className="text-[10px] font-bold text-gray-400 bg-gray-100 px-1.5 py-0.5 rounded">NEIN</span>
                    <div className="w-0.5 h-5 bg-gray-300" />
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white border border-gray-200 rounded-lg p-5 text-center">
              ...
              <h4 className="text-sm font-bold text-gray-900 mb-1">Schnelligkeit</h4>
              <p className="text-xs text-gray-500">Matching in 72h statt Wochen</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-5 text-center">
              <div className="w-10 h-10 rounded-full bg-[rgb(23,162,69)]/10 flex items-center justify-center mx-auto mb-3">
                <svg className="w-5 h-5 text-[rgb(23,162,69)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <h4 className="text-sm font-bold text-gray-900 mb-1">Qualität</h4>
              <p className="text-xs text-gray-500">Vorgeprüfte Senior-Entwickler</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-5 text-center">
              <div className="w-10 h-10 rounded-full bg-[rgb(23,162,69)]/10 flex items-center justify-center mx-auto mb-3">
                <svg className="w-5 h-5 text-[rgb(23,162,69)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <h4 className="text-sm font-bold text-gray-900 mb-1">DACH-Fokus</h4>
              <p className="text-xs text-gray-500">Deutschsprachig & EU-Zeitzonen</p>
            </div>
          </div>
