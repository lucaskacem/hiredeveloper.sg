    ...
    const talents = [
        {
            ...
            time: 'UTC-5',
            bio: 'Erfahrener Digital-Marketer, spezialisiert auf SEO- und PPC-Kampagnen, mit nachgewiesener Erfolgsbilanz bei der Wachstumsförderung von SaaS-Startups.',
        ...
        },
        {
            ...
            location: 'Kanada',
            time: 'UTC-5',
            bio: 'Content-Strategin mit Hintergrund in Tech und SaaS. Expertin für die Erstellung von ansprechenden Inhalten, die Conversions und Markenbekanntheit steigern.',
            tags: ['Content-Strategie', 'Texterstellung', 'Social Media'],
        ...
        },
        {
            ...
            time: 'UTC+0',
            bio: 'Datengetriebener Growth-Marketer mit über 7 Jahren Erfahrung. Ich helfe Unternehmen bei der Skalierung durch bezahlte Akquise und Conversion-Optimierung.',
        ...
        <section className="bg-[#f7f9fc] py-20">
            <div className="max-w-[1280px] mx-auto px-12">
                <h2 className="text-[28px] font-bold text-[#0b152b] mb-8">
                    1.684 Remote-Digital-Marketer und Experten verfügbar:
                </h2>
