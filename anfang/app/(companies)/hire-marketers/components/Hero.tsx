                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="text-white">
                        <h1 className="text-[52px] leading-[1.1] font-bold tracking-tight mb-8">
                            Stellen Sie die <span className="relative inline-block">
                                Top 2%
                            ...
                            <span className="text-[#96d0ff]">Freelance-Marketing-Experten</span> ein
                        </h1>

                        <p className="text-lg text-white/80 leading-relaxed max-w-[540px] mb-8">
                            Programmier-Anfang ist der einfachste Weg, geprüfte Remote-Marketer für Ihr Team zu finden und einzustellen.
                        </p>

                        <ul className="flex flex-wrap gap-x-8 gap-y-3 mb-10">
                            {['Freelance-Vertragnehmer', 'Vollzeitstellen', 'Globale Teams'].map((item) => (
                        ...
                        <div className="mb-12">
                            <button
                                onClick={openModal}
                                className="inline-block w-full sm:w-auto px-8 py-4 bg-[#22a447] hover:bg-[#1e913f] text-white text-[17px] font-bold rounded-lg transition-all transform hover:-translate-y-1 shadow-[0_4px_14px_rgba(34,164,71,0.4)] text-center"
                            >
                                Talente einstellen
                            </button>
                            <p className="mt-3 text-sm text-white/60 font-medium">
                                0 EUR bis zur Einstellung
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-lg p-8 shadow-2xl relative z-10 text-gray-900 border border-gray-100">
                            ...
                            <div className="flex justify-between gap-4 mb-10 border-b border-gray-100 pb-8">
                                <div className="text-center flex-1">
                                    <div className="text-[#22a447] text-2xl font-bold mb-1">Bis zu 75%</div>
                                    <div className="text-xs font-semibold text-gray-500 uppercase tracking-wide">schneller eingestellt</div>
                                </div>
                                <div className="w-px bg-gray-100"></div>
                                <div className="text-center flex-1">
                                    <div className="text-[#22a447] text-2xl font-bold mb-1">Bis zu 58%</div>
                                    <div className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Kostenersparnis</div>
                                </div>
                                <div className="w-px bg-gray-100"></div>
                                <div className="text-center flex-1">
                                    <div className="text-[#22a447] text-2xl font-bold mb-1">800+</div>
                                    <div className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Einstellungen</div>
                                </div>
                            </div>
                            ...
                            <div className="bg-gray-50 rounded-lg p-6 relative">
                                ...
                                <p className="text-gray-700 italic font-medium mb-4 leading-relaxed pt-2">
                                    &ldquo;Programmier-Anfang hat uns einen Superstar gefunden, der perfekt in unsere Kultur passt.&rdquo;
                                </p>

                                <div className="flex items-center justify-between">
                                    <div>
                                        <div className="font-bold text-gray-900 text-sm">Markus Gruber</div>
                                        <div className="text-gray-500 text-xs">CEO bei TechVenture GmbH</div>
                                    </div>
