...
const techLogoMap: Record<string, string> = {
  // === Programmiersprachen / Skills (devicon) ===
  'JavaScript-Entwickler': devicon('javascript'),
  'TypeScript-Entwickler': devicon('typescript'),
  'Python-Entwickler': devicon('python'),
  'Java-Entwickler': devicon('java'),
  'PHP-Entwickler': devicon('php'),
  'Ruby-Entwickler': devicon('ruby'),
  'C#-Entwickler': devicon('csharp'),
  'Go-Entwickler': devicon('go'),
  'Swift-Entwickler': devicon('swift'),
  'Kotlin-Entwickler': devicon('kotlin'),
  'Rust-Entwickler': devicon('rust'),
  'Scala-Entwickler': devicon('scala'),
  'Perl-Entwickler': devicon('perl'),
  'R-Entwickler': devicon('r'),

  // === Frameworks (devicon) ===
  'React-Entwickler': devicon('react'),
  'Angular-Entwickler': devicon('angularjs'),
  'Vue.js-Entwickler': devicon('vuejs'),
  'Node.js-Entwickler': devicon('nodejs'),
  'Django-Entwickler': devicon('django'),
  'Laravel-Entwickler': devicon('laravel'),
  'Rails-Entwickler': devicon('rails'),
  'Spring-Entwickler': devicon('spring'),
  'Next.js-Entwickler': devicon('nextjs'),
  'Flutter-Entwickler': devicon('flutter'),

  // === Datenbanken (devicon) ===
  'PostgreSQL-Entwickler': devicon('postgresql'),
  'MySQL-Entwickler': devicon('mysql'),
  'MongoDB-Entwickler': devicon('mongodb'),
  'Redis-Entwickler': devicon('redis'),
  'Oracle-Entwickler': devicon('oracle'),
  'SQLite-Entwickler': devicon('sqlite'),
  'Elasticsearch-Entwickler': devicon('elasticsearch'),

  // === Cloud/DevOps (devicon) ===
  'AWS-Entwickler': `https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/amazonwebservices/amazonwebservices-original-wordmark.svg`,
  'Azure-Entwickler': devicon('azure'),
  'Google Cloud-Entwickler': devicon('googlecloud'),
  'Docker-Entwickler': devicon('docker'),
  'Kubernetes-Entwickler': devicon('kubernetes'),

  // === E-Commerce (devicon where available) ===
  'WordPress-Entwickler': devicon('wordpress'),
  'Magento-Entwickler': devicon('magento'),
  'WooCommerce-Entwickler': devicon('woocommerce'),
};
...
function RoleIcon({ name }: { name: string }) {
  ...
  switch (name) {
    ...
    case 'KI-Entwickler':
    case 'Machine Learning Experten':
      // Brain icon
      return (
    ...
    case 'Administrative Assistenten':
      // Clipboard icon
      return (
        <svg className={cls} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    case 'Technische Produktmanager':
      // Wrench + cog icon
      return (
        <svg className={cls} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
