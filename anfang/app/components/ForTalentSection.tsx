        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-white/85 leading-relaxed mb-8">
              ...
              Werden Sie mit Startups und Technologieunternehmen im DACH-Raum gematcht.
            </p>
            ...
            <div className="w-full aspect-[4/3] rounded-2xl bg-gradient-to-br from-[rgb(0,159,255)]/20 to-violet-600/20 border border-white/10 flex items-center justify-center p-12">
              <div className="grid grid-cols-3 gap-4 w-full">
                <div className="flex flex-col items-center gap-3">
                  ...
                  <span className="text-white/60 text-xs text-center">Remote</span>
                </div>
                <div className="flex flex-col items-center gap-3">
                  ...
                  <span className="text-white/60 text-xs text-center">Entwicklung</span>
                </div>
                <div className="flex flex-col items-center gap-3">
                  ...
                  <span className="text-white/60 text-xs text-center">Teamarbeit</span>
                </div>
                <div className="flex flex-col items-center gap-3">
                  ...
                  <span className="text-white/60 text-xs text-center">Karriere</span>
                </div>
                <div className="flex flex-col items-center gap-3">
                  ...
                  <span className="text-white/60 text-xs text-center">Wachstum</span>
                </div>
                <div className="flex flex-col items-center gap-3">
                  ...
                  <span className="text-white/60 text-xs text-center">Work-Life</span>
                </div>
              </div>
            </div>
          </div>
