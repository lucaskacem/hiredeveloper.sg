  ...
  const features = [
    {
      ...
      description: 'Lernen Sie Kandidaten kennen, die bereits auf Fachwissen und Englischkenntnisse geprüft sind und direkt ins Interview starten können.'
    },
    {
      id: 'matches-seconds',
      title: 'Matches in Sekunden sehen',
      description: 'Kein endloses Sichten von Lebensläufen mehr. HireAI zeigt Ihnen passende Kandidaten in Sekunden.'
    },
    {
      id: 'global-hires',
    ...
    },
    {
      ...
      description: 'Bei der Einstellung von Remote-Talenten steht Ihnen unser Team erfahrener Recruiter mit persönlicher Beratung zur Seite.'
    }
  ];
