...
export const metadata: Metadata = {
  title: 'Privacy Policy | HireDeveloper.ae',
  description: 'Privacy Policy of HireDeveloper.ae. Information about the collection, processing, and use of your personal data in compliance with UAE data protection laws.',
  robots: {
    index: false,
    follow: false,
  },
        ...
        <div className="max-w-[800px] mx-auto px-6">
          ...
          <section className="mb-10">
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              ...
              Email: privacy@hiredeveloper.ae
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              This data is not merged with other data sources. The collection of this data is carried out in accordance with UAE Federal Decree-Law No. 45/2021 on the Protection of Personal Data and the DIFC Data Protection Law (DIFC Law No. 5 of 2020). The website operator has a legitimate interest in the technically error-free presentation and optimization of its website.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              The processing of data entered in the contact form is based on your consent, in accordance with UAE Federal Decree-Law No. 45/2021. You may revoke this consent at any time. The lawfulness of data processing operations carried out prior to the revocation remains unaffected.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              The information generated by cookies about your use of this website is generally transmitted to and stored on a server. Processing is carried out in accordance with our legitimate interests under the DIFC Data Protection Law and UAE Federal Decree-Law No. 45/2021.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-base text-gray-700 leading-relaxed mb-4">
              Under the UAE Federal Decree-Law No. 45/2021 and the DIFC Data Protection Law, you have the following rights regarding your personal data:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-base text-gray-700 leading-relaxed mb-4">
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              You also have the right to lodge a complaint with the UAE Data Office or the relevant data protection authority regarding our processing of your personal data.
            </p>
          </section>
