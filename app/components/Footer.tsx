    ...
    <footer className="bg-black text-white py-10 md:py-16">
      <div className="max-w-[1440px] mx-auto px-4 md:px-6 lg:px-12 w-full">
        ...
        <div className="flex items-center gap-4 md:gap-8 mb-6 md:mb-8 flex-wrap">
          <a href="mailto:hello@hiredeveloper.sg" className="text-xs md:text-sm text-white/60 hover:text-white transition-colors">
            hello@hiredeveloper.sg
          </a>
          <span className="text-xs md:text-sm text-white/40">Singapore</span>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-6">
          ...
          <div className="flex items-center gap-4">
            <a
              href="https://www.linkedin.com/company/hiredeveloper-sg"
              target="_blank"
            ...
            <a
              href="https://x.com/hiredevelopersg"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/60 hover:text-white transition-colors"
            ...
            <a
              href="https://www.youtube.com/@hiredevelopersg"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/60 hover:text-white transition-colors"
              aria-label="YouTube"
            ...
            <a
              href="https://www.facebook.com/hiredevelopersg"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/60 hover:text-white transition-colors"
              aria-label="Facebook"
